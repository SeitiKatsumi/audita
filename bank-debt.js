...
function analysisConsent(){return current?.documentConsent?'':'<label class="debt-check"><input type="checkbox" name="consent" required> Autorizo a análise dos documentos pela IA e pela equipe Audita.</label>';}
