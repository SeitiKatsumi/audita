...
function landing(){return bubble(`<p>Olá! Sou a assistente virtual <strong>IA AUDITA</strong>. Vou ajudar você a consultar possíveis <strong>cotas antigas do PIS/PASEP</strong>, de quem trabalhou com carteira assinada ou no serviço público entre 1971 e 1988.</p><p>A consulta é gratuita e feita por você no canal oficial, com minha orientação. Vamos conversar, uma pergunta por vez.</p><p><strong>Podemos começar?</strong></p><div class="charge-analysis-actions"><button type="button" data-pis-start><strong>Consultar cotas do PIS/PASEP</strong></button></div>${!state.user?'<p class="ir-micro">Entre na sua conta para salvar e retomar o atendimento.</p>':''}`);}
